...
<div class="list">
    ...
    <div class="list__month">
        <a class="list__month-link list__month-link--prev" href="{{ route('admin.staff.attendances', ['id' => $staff->id, 'month' => $prevMonth]) }}">
            ← 前月
        </a>

        <span class="list__month-label">{{ $monthLabel }}</span>

        <a class="list__month-link list__month-link--next" href="{{ route('admin.staff.attendances', ['id' => $staff->id, 'month' => $nextMonth]) }}">
            翌月 →
        </a>
    </div>
            ...
            <tbody class="list__tbody">
                @foreach ($attendances as $attendance)
                    <tr class="list__tr {{ $loop->last ? 'list__tr--last' : '' }}">
                        ...
                        <td class="list__td">
                            <a class="list__detail-link" href="{{ route('admin.attendance.detail', ['id' => $attendance->id]) }}">
                                詳細
                            </a>
                        </td>
                    </tr>
    ...
    <div class="list__actions">
        <a class="list__csv" href="{{ route('admin.staff.attendances.csv', ['id' => $staff->id, 'month' => request('month')]) }}">
            CSV出力
        </a>
    </div>
</div>
